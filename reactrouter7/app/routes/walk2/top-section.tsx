...
const useStore = create<{
  ...
  tab: "why_desk", // Default to first tab instead of null
  setTab: (tab) => set({tab}),
}));
...
<div>Budget mills deal less effectively with heat. To deal with this, reduce the amount of at-one-time walking. I recommend 30-45 minutes of walking, and a 1-5 minute break (turn off via remote). The occasional hour or two won&#39;t kill these machines; but running the belt for 8hrs a day might. I&#39;m a fan of the Pomodoro Technique for focus management. You work for 25 minutes (don&#39;t check emails / texts / Slack, nothing - pure hardcore work) and then take a break for 5 minutes to catch up on everything, or just de-steam. This fits perfectly with the treadmill. Work for 25-30, turn it off and go check your texts in the bathroom or whatever for 5 min, repeat. </div>
            ...
            <Tab.Pane eventKey="essentials">
              ...
              <div>
                ...
                The two budget picks are Keychron Q11 ($200) and <a href="key://mistel">Mistel Barocco MD770</a> ($144). I own Mistel, but the internet favors Keychron. The splurge pick is <a href="https://www.moergo.com/collections/glove80-keyboards">Glove80</a> ($400)
              </div>
              
              <h5><a href="https://amzn.to/4guIAGd">Wrist weights</a></h5>
              <div>If you wanna get really hard-core, use some wrist weights while you walk and type. This will engage your arms, shoulders, and back. I use these ankle weights (so I can crank up the weight, wrist weights are typically lighter) and wear them all day.</div>
              
              <h5>Monitor Arms: <a href="key://vivo">VIVO</a> or <a href="key://mountup">MountUp</a></h5>
              <div>I highly recommend using monitor arms instead of a stand; especially if you have multiple monitors. This allows you to position the monitors in a tighter cluster, since you have flexibility to angle them without worry of the base leaning over the edge. It also allows you to pull the monitors closer to your face, just above your mouse and keyboard, in a way you couldn't do with a stand.</div>
              
              <h5><a href="key://esd_wristband">ESD Wristband</a></h5>
              <div>When walking on a treadmill, you'll build static electricity. If you touch anything metal connected to your computer, you'll cause "electrostatic discharge" or ESD. This can be a monitor, peripherals which have any metal components, your laptop itself, etc. This can damage the electronics in the components you touched, and your computer (the current sent from the component through the connecting wire). There are two solutions: (1) make sure all the components you touch are plastic (SlimBlade and MD770 are), and never touch anything else (you monitor, laptop, etc) while walking; this is what I do. Or (2) buy an anti-static wristband, clamp it to something grounded, and now you don't have to worry about what you touch.</div>
              
              <h5><a href="key://gloves">Fingerless gloves</a></h5>
              <div>Since you'll be sweating a bunch, get some cheap cloth fingerless gloves to catch the sweat so it doesn't get on your keyboard or mouse. I tried wrist-bands, but it didn't catch sweat from the hands themselves.</div>
