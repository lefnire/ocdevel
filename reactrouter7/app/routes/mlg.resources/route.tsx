  ...
  return <div className="podcasts">
    ...
    <Container fluid className="resources">
      <div className='mb-3 mlg-update ps-3 small'>
        [Updated 2025-04-08] These are resources to learn machine learning & data science. The resources are in tree-structure, in descending order of value. Use the Filters on the left to narrow your search. Hover over each button for more help. To suggest a resource, or discuss/contend resources listed here, comment <a href="https://github.com/lefnire/ocdevel/issues/43" target="_blank">here</a>. <Link to="/walk">Try a walking desk</Link> to stay healthy while you study or work!
      </div>
      <Row>
