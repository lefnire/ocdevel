...
<TLDR>
  ...
  <div>
    ...
    <ul>
      <li>
        <div>Wedge: {al(prods.nulea_m512)}</div>
        <div className='ms-2'><small className='text-muted'>(but {al(prods.kensington_slimbladepro, "SlimBlade Pro")} is still a smidge better</small>)</div>
      </li>
...
As for Adept. It's my daily driver. It's my favorite mouse out there. Dynamic steel roller bearings makes stiction 0. If they rust, you can replace them. Ambidextrous for gaming vs productivity (I work left-hand, game right-hand). And great for hover-hand when I'm <Link to="/walk">walking</Link>. Ploopy really steals the stage, all around.
