...
### Mouse
<Alert>Update 2025-04-08: <Link reloadDocument to="/blog/20250408-trackball-mouse">updated recommendations</Link> for mice! Read below for background info, but see the new post for recommendations.</Alert>
...
<TLDR>Quality: [Glove80](https://www.moergo.com/), Budget: {al(prods.epomaker_split65)}</TLDR>
...
- Budget picks: {al(prods.keychron_q11)} ~$200, {al(prods.mistel_md770)} ~$150 or {al(prods.epomaker_split65)} ~$100. Least ergonomic on the list, but budget-friendly. You can tent them with {al(prods.keyboard_kickstands, "kickstands")}, see [my post](https://www.reddit.com/r/ErgoMechKeyboards/comments/10jtaf3/cheap_kick_stands_to_tent_keyboards/).
  - Pros: Inexpensive! Familiar format.
