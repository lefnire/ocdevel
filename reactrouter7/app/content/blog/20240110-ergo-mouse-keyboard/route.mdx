...
- Budget picks: {al(prods.mistel_md770)} ~$150 or {al(prods.keychron_q11)} ~$200. Least compelling on the list, but budget-friendly. I own Mistel; the internet favors Keychron. I tented mine with {al(prods.keyboard_kickstands, "kickstands")}, see [my post](https://www.reddit.com/r/ErgoMechKeyboards/comments/10jtaf3/cheap_kick_stands_to_tent_keyboards/).
  - Pros: Cheap. All keys.
...
<VideoButtonLg href="https://www.youtube.com/watch?v=B5brtSWg52c" />

[//]: # (<iframe width="560" height="315" src="https://www.youtube.com/embed/B5brtSWg52c?si=TGvJeWd442uBTBO8" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen loading="lazy"></iframe>)
