...
export default {
  ...
  teaser: "MLG teaches the fundamentals of machine learning and artificial intelligence. It covers intuition, models, math, languages, frameworks, etc. Where your other ML resources provide the trees, I provide the forest. Consider MLG your syllabus, with highly-curated resources for each episode's details at ocdevel.com. Audio is a great supplement during exercise, commute, chores, etc.",
  body: `
...
[00:04:08] So this podcast will provide you the overview of the models and the concepts. But if you're serious about learning machine learning, you're going to want to also spend time on the resources list where I have crafted for you. A step-by-step guide to effectively learn machine learning. Now this resources list is not only for the deep divers.

[00:04:31] There are also plenty of great resources listed on that page, including other podcasts, similar to machine learning guide. Some of my favorite podcasts that I listen to out there, various podcasts are news and interview based podcasts, where they interview experts in the field. And those experts discuss latest technologies and inventions and white papers.

[00:04:53] Some other podcasts and audio learning resources that are similar to MLG, whose goal is to teach you machine learning and other fields tangential to machine learning, such as math, operations research, and some more fun topics, more inspirational concepts in machine learning, things like the singularity and consciousness can robots be conscious and what is conscious?

[00:05:17] So after you listened to this episode, I recommend visiting ocdevel.com/mlg. There, you will find the resources list, which includes other audio supplementary resources that you may want to enjoy alongside this podcast, as well as the deep dive materials that you'll need during your learning.

[00:05:36] now as of October 20th, 2021 dept agency, D E P T has acquired the machine learning guide podcast. And they're paying me to work on it, which is fantastic. So I'm going to be breathing new life into the old podcasts. I'm going to be dusting off old episodes, fixing up some. Subjects which may be considered missing in the traditional machine learning educational path, things like decision trees and naive bayes.

[00:06:01] And they're bringing you machine learning applied for free. Previously machine learning applied was a separate paid podcast I had, which had discussed the applied things in machine learning, things like technology, stacks, programming, languages, job, hunting, machine learning, operations, where ML ops and all these things.

[00:06:19] So I'm going to be merging in these episodes into the main. Thanks to Dept's generosity. The value of depth to you as a listener is that I'm going to be using their projects as talking points for the various subjects I'm going to be discussing. So for example, if I'm discussing computer vision or natural language processing, I might pull in a adept project in those subjects further.

[00:06:39] Since this company does data science and machine learning. If you're listening to this podcast, because you want to tap into the industry will apply to them, apply to Dept by way of the links on ocdevel.com. Or if you're a manager listening to this podcast, trying to decide what is feasible by way of machine learning and what types of technologies are used in the space.

[00:06:58] And you're looking for talent will hire us. Dept is always looking for new clients. And since I'm on the team, Hey, you might have me as your engineer. If I don't have a depth case study project handy as a talking point for that episode, I'm going to be using my own personal project, gnothi

[00:07:13] G N O T H I Gnothi Seauton is ancient Greek for &quot;know thyself&quot; Gnothi is an online journal, a personal journal that uses.

[00:07:24] AI to provide resources and insights, things like book recommendations, therapists, suggestions, it generates themes of your journal entries, common recurring patterns. It allows you to ask questions of your journals. It allows you to generate summaries of your journal entries. So for example, give me one year's worth of journal entries in one paragraph, it allows you to share your journal entries with therapists so that they can use these tools as well. And then the project being open source. Gnothi is open source. You can go see the code. You can see how some computer vision algorithm is programmed in Python. Using TensorFlow in the wild, you can see how you would program a summarization model in the deep, natural language processing episodes in the future.

[00:08:12] 

[00:08:12] Note, as I'm redoing the podcast, you may find some gaps in your pod catcher. It looks like maybe an episode is missing. That's normal. It's because I've taken out older material that it's no longer relevant. And it's important to bear in mind that I discuss resources in my old episodes.

[00:08:29] At the end of the episode, I discussed them in the podcast episode. When you get to that point in the episode, Just skip ahead because this resources page on ocdevel.com is where I dump the resources. Now this allows me to keep things fresh and updated. As resources change as newer better resources become available for some specific topic, then I don't have to go back and edit an episode.

[00:08:54] So going forward as I revise these older episodes, I will no longer be including discussions of the resources themselves. Instead, you need to just go to the website to get the resource. Now, with all that meta out of the way, let's dive into the next episode where I define machine learning and artificial intelligence, how they differ from each other compared to data science and so on.

[00:09:14] I'll see you in the next episode.
`
}