...
import {
  ...
  FaChevronDown,
  FaChevronUp,
  FaInfoCircle, FaAngleRight, FaDollarSign, FaBriefcase, FaLightbulb, FaEnvelope, FaGithub
} from 'react-icons/all';
import {Helmet} from "react-helmet";

import Sidebar from './Sidebar'
import {BackButton, patreonLink, btns, Popover_} from './utils'
...
function Banner() {
  ...
  const li = {
    className: 'list-inline-item pr-5 banner-li'
  }
  ...
  function miscResources() {
    return <div>
      ...
      <ul className='list-inline w-100 text-center mb-0'>
        ...
        {enableHire && <li {...li} onClick={() => setShowHire(true)}>
