...
<span className="text-bg-warning">Update 2024-02-19</span> My picks have changed after knee-health research; specifically [3% incline is recommended](https://ocdevel.com/blog/20240228-walking-desks-incline). Expand last section for prior research. The video is long, but this is an expensive decision; watch before purchase.
