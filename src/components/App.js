    ...
    return (
      <div>
        ...
        <ul className="social-buttons">
          <li><a target="_blank" href="https://www.facebook.com/lefnire" className="zocial facebook icon">Facebook</a></li>
          <li><a target="_blank" href="https://www.linkedin.com/in/lefnire" className="zocial linkedin icon">LinkedIn</a></li>
        ...
        <Parallax bgImage={images.bgOCD} strength={400} log={true}>
          ...
          <ul className="social-buttons">
            <li><a target='_blank' href="https://www.facebook.com/lisa.haskellbunker" className="zocial facebook icon"/></li>
            <li><a target='_blank' href="https://www.linkedin.com/in/lisa-renelle-243413106" className="zocial linkedin icon"/></li>
            <li><a target='_blank' href="https://github.com/LisaMarie7073" className="zocial github icon"/></li>
            <li><a target='_blank' href="https://www.pinterest.com/lillisamhaskell/" className="zocial pinterest icon"/></li>
          </ul>
        </Parallax>
